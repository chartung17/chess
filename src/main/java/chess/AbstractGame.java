...
/**
 * This class represents a game or a replay of a game that can be displayed on the chess user
 * interface.
 */
public abstract class AbstractGame {
	 ...
	 * @param messageLine2 the second line of the message to be displayed to the user
	 ...
	 * @return a GameData object with the specified values and the current board state
	 */
	protected GameData generateData(String messageLine1, String messageLine2, boolean isPromotion,
			boolean isGameOver) {
		return new GameData(messageLine1, messageLine2, board.toByteArray(), isPromotion,
	 ...
	 * @param messageLine1 the first line of the message to be displayed to the user
	 * @param messageLine2 the second line of the message to be displayed to the user
	 * @return a GameData object with the specified values and the current board state, with
	 *         isPromotion set to false
	 */
	 ...
	 * @return one of the following constants: Board.SELECT for successfully selecting a piece,
	 *         Board.PROMOTE for a successful move resulting in a pawn needing to be promoted,
	 *         Board.CAPTURE for a move resulting in a piece being captured, Board.PAWN_MOVE for any
	 *         other successful move of a pawn, Board.MOVE for any other successful move, or
	 *         Board.FAILURE if unsuccessful
	 */
	 ...
	 * 
	 * @param option an integer indicating which option the user selected, corresponding to one of
	 *               the option constants defined in the Mediator class
	 */
