...
/**
 * This class is used to communicate between a UserInterface and an AbstractGame. It is also used by
 * the components of a GUI to communicate with the GUI.
 * 
 */
